...
//}@dev
    ...
    _fileHandler(url, readyCallback, errorCallback, responseType.toLowerCase(), options || {});
}
...
//}@dev
    ...
    _fileHandler(url, readyCallback, errorCallback, "", options || {});
}
...
//}@dev
    ...
    _fileHandler(url, readyCallback, errorCallback, "json", options || {});
}
...
//}@dev
    ...
    _fileHandler(url, readyCallback, errorCallback, "blob", options || {});
}
...
//}@dev
    ...
    _fileHandler(url, readyCallback, errorCallback, "arraybuffer", options || {});
}
