...
//}@dev
    ...
    case "blob":        _fireDetailError(errorCallback, "Sorry, Blob function is not implemented", url, 500);
    }
}
...
function _readFileAsync(url,           // @arg URLString
                        ...
                        readyCallback, // @arg Function - readyCallback(result:String, url:URLString, code:UINT16):void
